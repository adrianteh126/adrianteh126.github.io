  ...
  return (
    <>
      <div className="grid min-h-screen grid-flow-dense grid-cols-2 grid-rows-12 gap-3 bg-gradient-to-br from-slate-50 to-slate-100 p-4 *:rounded-lg *:px-6 *:py-4 sm:grid-cols-6 sm:gap-3 sm:p-6 lg:grid-cols-12 lg:gap-4 lg:p-8">
        {/* About Me */}
        <motion.div
          className="col-span-2 row-span-4 bg-slate-300/70 shadow-lg backdrop-blur-md sm:col-span-6 lg:col-span-4"
        ...
        {/* Education */}
        <motion.div
          className="col-span-2 row-span-3 bg-blue-300/70 shadow-lg backdrop-blur-md sm:col-span-3 lg:col-span-4"
          variants={cardVariants}
          initial="hidden"
          animate="visible"
        ...
        {/* Projects */}
        <motion.div
          className="col-span-2 row-span-7 flex flex-col justify-between bg-purple-300/70 shadow-lg backdrop-blur-md sm:col-span-6 lg:col-span-4"
          variants={cardVariants}
          initial="hidden"
          animate="visible"
        ...
        {/* Contact */}
        <motion.div
          className="col-span-2 row-span-4 bg-green-300/70 shadow-lg backdrop-blur-md sm:col-span-3 lg:col-span-4"
          variants={cardVariants}
          initial="hidden"
          animate="visible"
        ...
        {/* Skills */}
        <motion.div
          className="col-span-2 row-span-3 bg-orange-300/70 shadow-lg backdrop-blur-md sm:col-span-6 lg:col-span-4"
          variants={cardVariants}
          initial="hidden"
          animate="visible"
        ...
        {/* Experience */}
        <motion.div
          className="col-span-2 row-span-6 bg-teal-300/70 shadow-lg backdrop-blur-md sm:col-span-3 lg:col-span-3"
          variants={cardVariants}
          initial="hidden"
          animate="visible"
        ...
        {/* Testimonials */}
        <motion.div
          className="col-span-2 row-span-6 bg-red-300/70 shadow-lg backdrop-blur-md sm:col-span-3 lg:col-span-3"
          variants={cardVariants}
          initial="hidden"
          animate="visible"
        ...
        {/* Blog */}
        <motion.div
          className="col-span-2 row-span-6 flex flex-col justify-between bg-yellow-300/70 shadow-lg backdrop-blur-md sm:col-span-6 lg:col-span-6"
          variants={cardVariants}
          initial="hidden"
          animate="visible"
